...
# time (sidecar/src/pdf/render.rs). Idempotent: exits early when
# sidecar/pdfium/libpdfium.so already exists.
#
...
echo "fetch-pdfium: installed $version at sidecar/pdfium/libpdfium.so"
