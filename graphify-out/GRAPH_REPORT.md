...
## Corpus Check
- 275 files · ~191,737 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2663 nodes · 6097 edges · 163 communities (127 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 123 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94065f52`
...
### Community 5 - "cn"
Cohesion: 0.05
Nodes (66): BookMetadataDialog(), BookMetadataDialogProps, fromForm(), MetadataFormState, toForm(), CollectionDialogProps, NoSearchResultsStateProps, PdfToolbarProps (+58 more)

### Community 6 - "Book"
Cohesion: 0.09
Nodes (32): BookCard(), BookCardProps, InteractiveBookProps, progressPercentOf(), BookContextMenu(), BookContextMenuProps, BookCover(), BookCoverProps (+24 more)

### Community 7 - "metadata.e2e.ts"
Cohesion: 0.31
Nodes (5): seededBookTitles, ensureLibrary(), openBookDetail(), waitForLibraryView(), seededEpub
...
Cohesion: 0.19
Nodes (16): App(), AppShell(), AppStateProvider(), ImportProvider(), LibraryDataProvider(), renderDialog(), withData(), makeBook() (+8 more)
...
Cohesion: 0.21
Nodes (8): GeometryState, PdfGeometry, usePdfGeometry(), PageSize, MAX_THUMBNAIL_CANVASES, PdfSidebarProps, THUMBNAIL_WIDTH_PX, PdfDocument

### Community 13 - "Reconciler"
Cohesion: 0.19
Nodes (18): Handle, OnChange, file_stats(), ImportOutcome, is_book_extension(), is_book_path(), LibraryChange, Reconciler (+10 more)
...
Cohesion: 0.16
Nodes (18): GlobalSearchShortcut(), isHighlightColor(), normalizeRect(), PdfAnchorInfo, READING_ANCHOR_RATIO, setScrollTop(), usePdfScrollTracking(), PdfVirtualization (+10 more)

### Community 17 - "ReaderShell.tsx"
Cohesion: 0.06
Nodes (55): byKind(), isBookmarkAtLocator(), isBookmarkAtPage(), ReaderAnnotationController, EpubReader(), EpubReaderProps, EpubSavedState, forwardSectionKeys() (+47 more)
...
Cohesion: 0.07
Nodes (36): annotationRects(), DEFAULT_HIGHLIGHT_COLOR, HIGHLIGHT_COLORS, HighlightColor, highlightCssColor(), PdfHighlightOverlay(), COLOR_ORDER, ReaderAnnotationList() (+28 more)

### Community 21 - "parse_epub"
Cohesion: 0.17
...
Cohesion: 0.20
Nodes (23): Event, EventKind, access_and_unknown_events_are_ignored(), classify_event(), close_write_is_a_modification(), create(), duplicate_events_collapse_into_one_change(), event() (+15 more)
...
Cohesion: 0.07
Nodes (63): DropZoneOverlay(), EmptyLibraryState(), ImportStatus(), LibraryHeader(), PROGRESS_SAVE_DEBOUNCE_MS, ReaderProgressOptions, useReaderProgress(), AnnotationSnapshot (+55 more)
...
Cohesion: 0.16
Nodes (15): usePdfSearch(), UsePdfSearchOptions, ReaderSearchGroup, cancelPdfPrewarm(), EngineTextLine, getPdfOutline(), getPdfPageText(), PendingRequest (+7 more)
...
Cohesion: 0.10
Nodes (28): epubHrefJump(), ReaderJump, flattenOutline(), flattenToc(), OutlineRow, ReaderNavigation(), ReaderNavigationProps, ReaderNavTab (+20 more)

### Community 39 - "usePdfDocument.ts"
Cohesion: 0.26
...
Cohesion: 0.08
Nodes (42): BookDetail(), formatDate(), CollectionDialog(), Shell(), ItemButton(), ItemButtonProps, LIBRARY_ITEMS, Sidebar() (+34 more)
...
### Community 45 - "commands/collections.rs"
Cohesion: 0.38
...
### Community 56 - "EventBatch"
Cohesion: 0.36
Nodes (6): PathChange, EventBatch, flush(), paths(), String, Vec
...
### Community 59 - "playwright.config.ts"
Cohesion: 0.33
Nodes (4): ci, SEEDED_EXCLUDE, artifactsDir, @playwright/test

### Community 60 - ".serialize"
Cohesion: 0.40
Nodes (4): Error, Ok, Result, S
...
Cohesion: 0.11
Nodes (22): configDir, databasePath, killStaleProcesses(), libraryDir, prepareEnvironment(), pruneOldArtifacts(), pruneOldScratchDirs(), runId (+14 more)
...
Cohesion: 0.19
Nodes (27): openReadyEpub(), bitmapCacheUsage(), canvasIsNonBlank(), clickUntilEffect(), closeReaderNavigation(), currentPageNumber(), epubHostCount(), firstPdfCanvas() (+19 more)

### Community 83 - "LibraryWatcher"
Cohesion: 0.13
Nodes (16): Debug, Duration, FnOnce, Formatter, Mutex, RecommendedWatcher, LibraryWatcher, Arc (+8 more)
...
Cohesion: 0.38
Nodes (8): armTeardownWatchdog(), repoRoot, globalSetup(), formatVersionBanner(), PkgVersion, requireFromE2e, stackVersions, writeEnvironmentRecord()
...
Cohesion: 0.23
Nodes (25): MigrateError, AppError, Serialize, String, apply_effective(), clear_overrides(), EffectiveValues, ensure_series() (+17 more)
...
Cohesion: 0.38
Nodes (4): currentSection(), engineFraction(), engineMovedPast(), epubLocator()

### Community 253 - "electron-app.ts"
Cohesion: 0.12
Nodes (13): appArgs, deviceScaleFactor, launchElectronApp(), logLine(), patchEnvironmentRecord(), test, TestFixtures, versions (+5 more)
...
## Knowledge Gaps
- **596 isolated node(s):** `$schema`, `plugin`, `printWidth`, `semi`, `singleQuote` (+591 more)
...
- **Why does `AppError` connect `AppError` to `services/metadata.rs`, `repository/reading_progress.rs`, `repository/books.rs`, `repository/collections.rs`, `Reconciler`, `rpc.rs`, `EpubError`, `library_watcher.rs`, `search.rs`, `services/annotations.rs`, `commands/annotations.rs`, `artwork_cache.rs`, `services/reader.rs`, `commands/books.rs`, `book_importer.rs`, `commands/reader.rs`, `commands/collections.rs`, `lib.rs`, `library_locations.rs`, `.serialize`, `LibraryWatcher`, `library_scanner.rs`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `react` connect `cn` to `EpubReader.test.tsx`, `Book`, `AppShell.tsx`, `shortcuts.ts`, `PdfDocument`, `PdfReader.tsx`, `ReaderShell.tsx`, `domain.ts`, `lib/bridge.ts`, `pdf/pdfEngine.ts`, `pdfLayout.ts`, `appState.ts`, `PdfDocumentView.tsx`, `ReaderNavigation.tsx`, `usePdfDocument.ts`, `useEpubDocument.ts`, `LibraryView.tsx`, `PdfPageCanvas.tsx`, `PdfReader.test.tsx`, `frontend/package.json`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `ReadiumEpubHandle` connect `ReadiumEpubHandle` to `EpubReader.test.tsx`, `useEpubDocument.ts`, `ReaderShell.tsx`, `.resolveInitialLocator`, `.handlePositionChanged`, `epub/readiumEngine.ts`?**
